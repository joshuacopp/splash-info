# Claims Beta Test Guide

Thanks for testing. Two flows: **submit a claim** (customer side) and **work a claim** (admin side). Should take you ~10 minutes total.
...
5. Check your email — the confirmation should arrive within ~2 minutes.

**What we want to know:**
- Did anything confuse you?
- Did the form work on your phone (not just desktop)?
- Did the email + PDF arrive? Did the PDF look right?
- Anything slow, broken, or weird?
...
3. Try these actions in order:
   ...
   - Try **another transition** to push it further along the workflow

**What we want to know:**
- Could you find what you needed without hunting?
- Did the status buttons make sense, or were any greyed out when you didn't expect?
...
Email Josh, or reply to the kickoff email. Screenshots > paragraphs. If something broke, tell us **what you clicked** right before it broke.
