 ...
 * semantically identical to sending none, and the six-value set contains the
 * poisoned pair below — so "all statuses" is precisely the request that comes
 * back empty. Omit `statuses` instead.
 *
